...
route: /development-setup/docker
---
...
![assets/03-docker/10.png](assets/03-docker/10.png)

윈도우 버전은 명령 프롬프트에서 ver 명령으로도 확인 가능합니다.

![assets/03-docker/11.png](assets/03-docker/11.png)
...
![assets/03-docker/12.png](assets/03-docker/12.png)
...
![assets/03-docker/13.png](assets/03-docker/13.png)
...
![assets/03-docker/14.png](assets/03-docker/14.png)
...
![assets/03-docker/15.png](assets/03-docker/15.png)
...
![assets/03-docker/01.png](assets/03-docker/01.png)

![assets/03-docker/02.png](assets/03-docker/02.png)

- VirtualBox에서 머신폴더를 마운트합니다.

![assets/03-docker/03.png](assets/03-docker/03.png)

![assets/03-docker/04.png](assets/03-docker/04.png)
...
![assets/03-docker/19.png](assets/03-docker/19.png)
...
![assets/03-docker/05.png](assets/03-docker/05.png)

![assets/03-docker/06.png](assets/03-docker/06.png)
...
![assets/03-docker/07.png](assets/03-docker/07.png)

![assets/03-docker/08.png](assets/03-docker/08.png)
...
![assets/03-docker/20.png](assets/03-docker/20.png)

다음과 같이 docker-desktop 배포판을 확인하실 수 있습니다.

![assets/03-docker/21.png](assets/03-docker/21.png)
...
![assets/03-docker/09.png](assets/03-docker/09.png)
